...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::community::set_package_enabled,
            commands::community::set_packages_enabled,
            commands::community::list_addon_links,
            commands::community::add_addon_link,
            ...
            commands::perf::perf_scan_all_from_source,
